#abonelik detayları soap servis çağrısının yapıldığı sınıfı temsil etmektedir.
# soap çağrısı sonucunda oluşan xml çıktısı sonuç olarak dönderilmektedir.
class Selectsubscriberdetail
    ...
    def execute(subscriberId , token)
        ...
        response=  client.call(:select_subscriber_detail, message: {
